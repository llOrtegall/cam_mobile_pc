...
struct CamPCApp {
    ...
    // doesn't become an orphan holding the virtual camera after campc exits.
    ...
    fn render_controls(&mut self, ctx: &egui::Context) {
        egui::TopBottomPanel::bottom("controls")
            ...
            .show(ctx, |ui| {
                ...
                // Zoom slider (preview-only — virtual camera output remains 1280×720)
                ui.horizontal(|ui| {
...
impl eframe::App for CamPCApp {
    ...
    fn on_exit(&mut self, _gl: Option<&eframe::glow::Context>) {
        ...
        // the virtual camera. The engine might not have processed Stop yet.
